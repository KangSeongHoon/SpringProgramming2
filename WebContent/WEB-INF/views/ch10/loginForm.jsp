...
<body>
	...
	<form method="post" action="login" onsubmit="return checkForm()">
		<div class="form-group">
			<label for="mid">ID</label> <input id="mid" type="text"
				name="mid" class="form-control" placeholder="아이드를 입력" /> <span
		...
		<div class="form-group">
			<label for="mpassword"> PASSWORD</label> <input id="mpassword"
				...
				placeholder="패스워드를 입력하서요" /> <span id="mpasswordError" class="error"
				style="color: red">${mpassworderror }</span>
